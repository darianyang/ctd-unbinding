...
def calc_sasa(selection):
    ...
    traj_parent = mdtraj.load(f"{wpath}/parent.ncrst", top="2kod_m01_solv.prmtop") 
    traj_segment = mdtraj.load(f"{wpath}/seg.nc", top="2kod_m01_solv.prmtop")
    traj = traj_parent+traj_segment

    #traj = mdtraj.load(f"{wpath}/eg5_2022.pdb")
    #traj = mdtraj.load("../bstates/05_eq3.ncrst", top="2kod_m01_solv.prmtop")
