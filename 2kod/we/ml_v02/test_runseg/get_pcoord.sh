...
#TMP=$(mktemp -u)
#echo "MADE TMP: $TMP"
WEST_SIM_ROOT=/ihome/lchong/dty7/ix/ctd-unbinding/2kod/we/ml_v02
...
# calc weighted avgs
python $WEST_SIM_ROOT/common_files/weighted_dmat_pcoord.py $WEST_SIM_ROOT/common_files/m1w184_m2_dmat.dat $WEST_SIM_ROOT/common_files/m1w184_m2_weights.txt w_avgs_m1.txt
python $WEST_SIM_ROOT/common_files/weighted_dmat_pcoord.py $WEST_SIM_ROOT/common_files/m2w184_m1_dmat.dat $WEST_SIM_ROOT/common_files/m2w184_m1_weights.txt w_avgs_m2.txt
...
paste <(cat w_avgs_pdt.txt) <(cat pcoord.dat | tail -n +2 | awk '{print $6}') > pcoord.out
